...
public extension TouchBarSymbol {
	...
	static var audioOutputMute: Self { Self(NSImage.touchBarAudioOutputMuteTemplateName) }
	...
	static var audioOutputVolumeHigh: Self { Self(NSImage.touchBarAudioOutputVolumeHighTemplateName) }
	...
	static var audioOutputVolumeLow: Self { Self(NSImage.touchBarAudioOutputVolumeLowTemplateName) }
	...
	static var audioOutputVolumeMedium: Self { Self(NSImage.touchBarAudioOutputVolumeMediumTemplateName) }
	...
	static var communicationAudio: Self { Self(NSImage.touchBarCommunicationAudioTemplateName) }
	...
	static var communicationVideo: Self { Self(NSImage.touchBarCommunicationVideoTemplateName) }
	...
	static var newFolder: Self { Self(NSImage.touchBarNewFolderTemplateName) }
	...
	static var share: Self { Self(NSImage.touchBarShareTemplateName) }
	...
	static var skipBack15Seconds: Self { Self(NSImage.touchBarSkipBack15SecondsTemplateName) }
	...
	static var skipToEnd: Self { Self(NSImage.touchBarSkipToEndTemplateName) }

	/// The symbol for
	/// [`touchBarSkipToStartTemplateName`](https://developer.apple.com/documentation/appkit/nsimage/touchBarSkipToStartTemplateName)\.
	static var skipToStart: Self { Self(NSImage.touchBarSkipToStartTemplateName) }
	...
	static var textCenterAlign: Self { Self(NSImage.touchBarTextCenterAlignTemplateName) }

	/// The symbol for
	/// [`touchBarTextItalicTemplateName`](https://developer.apple.com/documentation/appkit/nsimage/touchBarTextItalicTemplateName)\.
	static var textItalic: Self { Self(NSImage.touchBarTextItalicTemplateName) }
	...
	static var textJustifiedAlign: Self { Self(NSImage.touchBarTextJustifiedAlignTemplateName) }
	...
	static var textLeftAlign: Self { Self(NSImage.touchBarTextLeftAlignTemplateName) }

	/// The symbol for
	/// [`touchBarTextListTemplateName`](https://developer.apple.com/documentation/appkit/nsimage/touchBarTextListTemplateName)\.
	static var textList: Self { Self(NSImage.touchBarTextListTemplateName) }
	...
	static var textRightAlign: Self { Self(NSImage.touchBarTextRightAlignTemplateName) }
	...
	static var textStrikethrough: Self { Self(NSImage.touchBarTextStrikethroughTemplateName) }
	...
	static var volumeDown: Self { Self(NSImage.touchBarVolumeDownTemplateName) }
